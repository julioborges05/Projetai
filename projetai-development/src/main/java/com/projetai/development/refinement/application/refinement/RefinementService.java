...
public class RefinementService {
    ...
    public void completeRefinement(RefinementDto refinementDto) {
        ...
        if (refinementEntityOp.isEmpty()) {
            throw new RuntimeException("Refinement not found");
        }
        ...
        Refinement refinement = new Refinement(refinementEntityOp.get().getId(), refinementDto.isApproved(), refinementDto.necessaryAdjustments(),
        ...
        if (!refinementDto.isApproved()) {
            AdjustmentsDto adjustmentsDto = new AdjustmentsDto(refinementDto.developerId(), ticketOp.get().getId(),
                    refinementDto.necessaryAdjustments(), refinementDto.techLeadId());

            developmentService.makeAdjustments(adjustmentsDto);
        } else {
